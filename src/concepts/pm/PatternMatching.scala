...
/**
 * Created by Abhisek Bastia on 5/19/2020.
 */
object PatternMatching extends App {
  ...
  val abhi = Person("Abhi", 29)

  val greeting = abhi match {
    case Person(n, a) if a < 21 => s"Hi, my name is $n and I can't drink in Bangalore"
